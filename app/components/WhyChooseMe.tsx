...
export default function WhyChooseMe() {
  ...
  return (
    <section id="why" className="bg-slate-50 py-36 mb-24">
      <div className="max-w-6xl px-4 mx-auto">
        <h2 className="mb-14 text-4xl font-extrabold tracking-tight text-center text-slate-900 inline-flex items-center justify-center gap-3">
